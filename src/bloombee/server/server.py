...
class Server:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Explicitly disable relay usage regardless of caller-provided defaults.
        use_relay = False
        use_auto_relay = False
        reachable_via_relay = False
        logger.info("Relay is explicitly disabled for this server")
        self.dht = DHT(
        ...
        self.reachability_protocol = ReachabilityProtocol.attach_to_dht(self.dht) if not reachable_via_relay and not skip_reachability_check else None
